        ...
        if ($(window).width() > 1025) {
            ...
            Bizweb.getProduct(producthandle, function (product) {
                ...
                if (featured_image == null) {
                    featured_image = 'images/products/noimage.gif';
                }
...
function loadQuickViewSlider(n, r) {
    ...
    r.find(".quickview-featured-image").append(
        '<a href="' + n.url + '"><img src="' + s + '" alt="' + n.title + '"/>' +
            '<div style="height: 100%; width: 100%; top:0; left:0 z-index: 2000; position: absolute; display: none; ' +
            'background: url(' + window.loading_url + ') 50% 50% no-repeat;">' +
            '</div>' +
        '</a>');
